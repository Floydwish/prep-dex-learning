...
想象一下，你是个炒币交易者，想在期货市场做多比特币。传统期货就像租车，合同到期了你就得还车或续租（展期），每次续租还得交手续费。更麻烦的是，如果你忘记了还车时间，车行直接收回车辆，你的出行计划就中断了。

永续合约的出现，彻底解决了这个痛点。它就像买车，想开多久开多久，只要按时交保险费（资金费率）就行。这背后是 DeFi 生态的一次重要创新，让去中心化交易变得更加灵活和用户友好。
...
> 💡 **通俗理解**：永续合约像买车，传统期货像租车

### 🔧 资金费率机制

> **资金费率** 是永续合约的核心创新，确保价格锚定

**运作原理**：
1. **价格监控** → 监控永续价格与现货价格的偏差
2. **费率计算** → 根据偏差收取调节费（通常 ±0.01%-0.75%）
3. **费用支付** → 每 8 小时，价格高的一方给价格低的一方支付费用
4. **价格回归** → 通过费用激励促使价格回归现货水平

**实际例子**：
- 比特币现货 30,000 美元，永续价格 30,100 美元
  - 做多的人给做空的人支付费用 → 鼓励做空 → 价格下降
- 比特币现货 30,000 美元，永续价格 29,900 美元  
  - 做空的人给做多的人支付费用 → 鼓励做多 → 价格上升

> 💡 **为什么每 8 小时结算？** 就像银行定时计算利息，避免价格偏离太远
