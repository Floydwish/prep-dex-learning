...
- [通用问题](#通用问题)
  - [Perp DEX 基础概念与定义](#perp-dex-基础概念与定义-表格)
  - [交易机制与用户体验](#交易机制与用户体验-表格)
  - [经济模型与流动性](#经济模型与流动性-表格)
  - [风险管理与安全性](#风险管理与安全性-表格)
  - [竞争与市场定位](#竞争与市场定位-表格)
  - [社区、治理与路线图](#社区治理与路线图-表格)
  - [高级功能与创新](#高级功能与创新-表格)
  - [挑战、机遇与未来](#挑战机遇与未来-表格)
- [开发者问题](#开发者问题)
  - [智能合约与核心逻辑](#智能合约与核心逻辑-表格)
  - [技术架构与实现](#技术架构与实现-表格)
  - [预言机与市场数据](#预言机与市场数据-表格)
  - [流动性与风险管理](#流动性与风险管理-表格)
  - [前端与用户体验](#前端与用户体验-表格)
  - [安全与测试](#安全与测试-表格)
...
| 序号 | 问题描述 | 问题状态 |
|------|----------|----------|
| 1 | 什么是永续合约？它与传统期货在哪些方面存在根本性差异？ | ⏳ 待完善 |
| 2 | Perp DEX 的核心存在意义或价值主张是什么？它解决了哪些现有的市场痛点？ | ⏳ 待完善 |
| 3 | Perp DEX 与现货 DEX 的主要区别在交易机制、流动性和风险管理上分别体现在哪里？ | ⏳ 待完善 |
| 4 | 永续合约为什么必须依赖资金费率（Funding Rate）机制？其目的是什么？ | ⏳ 待完善 |
| 5 | 资金费率是如何计算的？（详细的数学模型） | ⏳ 待完善 |
