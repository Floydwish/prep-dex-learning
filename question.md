...
## ❓ 问题
永续合约的保证金要求和清算机制是如何设计的？

> **核心答案**：保证金是"押金"，清算是"风控"。这套系统通过**初始保证金**设门槛、**维持保证金**划红线、**强制平仓**做裁决，确保交易者亏不完本金，平台也能稳定运行。
...
- **触发条件**：保证金余额 ≤ 维持保证金水平
- **设计目的**：在你亏光本金前强行止损，防止欠债

### 3. 保证金模式：选择你的"风险防火墙"

#### 🔒 逐仓模式（隔离仓位）
- **优点**：每个头寸保证金独立，一个爆仓不影响其他
- **缺点**：抗波动能力弱，更容易被小幅震荡爆仓
- **适合**：新手、高风险策略、想严格控制单笔亏损的交易者

#### 🌊 全仓模式（共享资金）
- **优点**：所有资金共享，抗风险能力强
- **缺点**：一旦爆仓可能亏光整个账户
- **适合**：经验丰富、能准确把握整体风险的老手
...
| 机制 | 作用 | 对交易者的意义 |
|------|------|----------------|
| **初始保证金** | 设门槛 | 控制开局风险，防止乱开仓 |
| **维持保证金** | 划红线 | 设止损底线，防止亏完本金 |
| **强制平仓** | 自动执行 | 无情但公平，保护双方 |
| **保险基金** | 兜底损失 | 极端行情的"安全垫" |
| **ADL** | 最后防线 | 防止系统崩溃的"壮士断腕" |

**一句话记住**：保证金是你玩的"本金"，清算是系统的"刹车"。理解这套机制，不是让你怂，而是让你**更专业地管理风险**。
---
